...
var $author$project$Main$initModel = {fileName: '', fileText: ''};
...
var $author$project$Main$SelectFile = function (a) {
			...
			case 'Pressed':
				return _Utils_Tuple2(
					...
					A2(
						...
						_List_fromArray(
							[model.fileName]),
						$author$project$Main$SelectFile));
			case 'Open':
				var str = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Main$Pressed)
					]),
				_List_fromArray(
					[
				...
				$elm$html$Html$text(model.fileText)
			]));
};
